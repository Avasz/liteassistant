        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage automated switch schedules</p>
                    {serverTime && (
            ...
            {schedules.length === 0 ? (
                <div className="bg-white p-12 rounded-lg shadow-sm text-center border border-gray-100">
                    ...
                    <p className="text-gray-500 mb-4">Create your first schedule to automate your devices</p>
                    <button
                        onClick={() => setShowForm(true)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {schedules.map(schedule => (
                        <div
                            key={schedule.id}
                            className={`bg-white rounded-lg shadow-sm border p-4 ${schedule.enabled ? 'border-gray-200' : 'border-gray-300 opacity-60'
                                }`}
                        >
                            <div className="flex items-start justify-between mb-3">
                                <div className="flex-1">
                                    <h3 className="font-semibold text-gray-900">{schedule.name}</h3>
                                    <p className="text-sm text-gray-500">{getDeviceName(schedule.device_id)}</p>
                                </div>
                            ...
                            <div className="space-y-2 mb-4">
                                ...
                                <div className="flex items-center gap-2 text-sm">
                                    ...
                                    <span className="text-gray-700">{formatScheduleType(schedule)}</span>
                                </div>
                                <div className="flex items-center gap-2 text-sm">
